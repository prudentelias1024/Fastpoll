            ...
            success: (res) => {
                ...
                if(res.success == false){
                  ...
                  res.forEach((poll) => {
                    ...
                    poll.closes_on = new Date(poll.closes_on)
                    if (poll.voted == false ) {
                    ...
                    let markup = ` <div class='poll flex flex-col gap-[1em] font-[Outfit]   p-[1em] rounded-md shadow-sm border w-[50%] ml-[7.5em] mt-[1em]' id=${poll.id}><div class='flex flex-row '> <img src=${poll.profile_img} alt='profile_pic' class='h-[3em] w-[3em] rounded-full object-cover'> <div  class='ml-[1em] flex flex-col '> <p class='font-bold'>${poll.fullname}</p><p class='font-bold text-[#d3d2d2]'>${poll.username}</p> </div>  </div><p class='font-bold mt-[1em]'>${poll.text}</p>
                     <div onClick='vote(event)' name='${poll.option_1}'  class='cursor-pointer relative flex flex-row justify-between text-[#d3d2d2] border border-[#d3d2d2] rounded-md font-bold p-[.5em]'>

                     <div value='${option_one_percentage}'  name='${poll.option_1}'  style="width: ${option_one_percentage}%; z-index:-1;" class='poll_results absolute w-[${option_one_percentage}%]   p-[.5em] bg-[#ebebeb]   ml-[-.5em] mt-[-.5em]' >&nbsp</div>  
                     <p >${poll.option_1}</p> 
                     <p value=${poll.option_one_count} class='option_one_count' class='option_value'>${option_one_percentage}%</p>  
                     </div>
                     
                     <div onClick='vote(event)' name='${poll.option_2}' class='cursor-pointer relative flex flex-row justify-between text-[#d3d2d2] border border-[#d3d2d2] rounded-md font-bold p-[.5em]'  >

                     <div name='${poll.option_2}' value='${option_two_percentage}'  style="width: ${option_two_percentage}%; z-index:-1;" class='poll_results absolute w-[${option_one_percentage}%]   p-[.5em] bg-[#ebebeb]   ml-[-.5em] mt-[-.5em]' >&nbsp</div>  
                     ...
                     <div value='${option_three_percentage}'  name='${poll.option_3}'  style="width: ${option_three_percentage}%; z-index:-1;" class='poll_results absolute w-[${option_one_percentage}%]   p-[.5em] bg-[#ebebeb]   ml-[-.5em] mt-[-.5em]' >&nbsp</div>  
                     <p>${poll.option_3}</p> 
                      <p value=${poll.option_three_count} class='option_three_count'>${option_three_percentage}%</p> 
                        </div>

                         <div onClick='vote(event)' ${poll.option_4 == '' ?"style='display:none;'": ''} class='  cursor-pointer relative flex flex-row justify-between text-[#d3d2d2] border border-[#d3d2d2] rounded-md font-bold p-[.5em]' > 

                         <div value='${option_four_percentage}'  name='${poll.option_4}' style="width: ${option_four_percentage}%; z-index:-1;" class='poll_results absolute w-[${option_one_percentage}%]   p-[.5em] bg-[#ebebeb]   ml-[-.5em] mt-[-.5em]' >&nbsp</div>  
            ...
            for (let index = 0; index < poll_results.length; index++) {
              if(poll_results[index].getAttribute('value') == 0) {
                poll_results[index].remove()
                      ...
                      let markup =       `    <div class='poll flex flex-col gap-[1em] font-[Outfit]   p-[1em] rounded-md shadow-sm border w-[50%] ml-[7.5em] mt-[1em]' id="${poll.id}"><div class='flex flex-row '> <img src=${poll.profile_img} alt='profile_pic' class='h-[3em] w-[3em] rounded-full object-cover'> <div  class='ml-[1em] flex flex-col '> <p class='font-bold'>${poll.fullname}</p><p class='font-bold text-[#d3d2d2]'>${poll.username}</p> </div>  </div><p class='font-bold mt-[1em]'>${poll.text}</p> <div class='flex  lg:w-[30.15em] relative flex-row justify-between  text-[#d3d2d2] border border-[#d3d2d2] rounded-md font-bold p-[.5em] ' style="z-index: 63;">  
                      <div value='
${option_one_percentage}' style="width: ${option_one_percentage}%; z-index:-1;" class='poll_results absolute w-[${option_one_percentage}%]   p-[.5em] bg-[#ebebeb]   ml-[-.5em] mt-[-.5em]' >&nbsp</div>   <p>${poll.option_1}</p>   <p>${option_one_percentage}%</p></div>    
...
<div ${poll.option_3 == '' ?"style='display:none;'": ''} class='flex   lg:w-[30.15em]  relative flex-row justify-between  text-[#d3d2d2] border border-[#d3d2d2] rounded-md font-bold p-[.5em] ' style="z-index: 63;">  
<div  value='${option_three_percentage}' style="width: ${option_three_percentage}%; z-index:-1;" class='poll_results absolute w-[${option_three_percentage}%]   p-[.5em] bg-[#ebebeb]   ml-[-.5em] mt-[-.5em]'>&nbsp</div>  <p>${poll.option_3}</p><p>${option_three_percentage}%</p></div>   
...
<div ${poll.option_4 == '' ?"style='display:none;'": ''}  class='flex   lg:w-[30.15em]  relative flex-row justify-between  text-[#d3d2d2] border border-[#d3d2d2] rounded-md font-bold p-[.5em] ' style="z-index: 63;"> <div value='${option_four_percentage}'       style="width: ${option_four_percentage}%; z-index:-1;" class='poll_results absolute w-[${option_four_percentage}%]   p-[.5em] bg-[#ebebeb]   ml-[-.5em] mt-[-.5em]' style='z-index: -1'>&nbsp</div>  <p>${poll.option_4}</p>  <p>${option_four_percentage}%</p></div><p class='text-[#d3d2d2]  font-bold mt-[1em]'>${total} Votes</p></div>`
    ...
    <p class='text-[#d3d2d2]  font-bold mt-[1em]'>${total} Votes</p>
            ...
            for (let index = 0; index < poll_results.length; index++) {
              ...
              if(poll_results[index].getAttribute('option')){
